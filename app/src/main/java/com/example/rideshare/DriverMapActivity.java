...
public class DriverMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void checkLocationPermission() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                // this thread waiting for the us   er's response! After the user
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                if (mAuth.getCurrentUser() != null) {
                    ...
                    DatabaseReference driverRefAvailable = FirebaseDatabase.getInstance().getReference("driversAvailable");
    ...
    private void disconnectCustomer(){
        ...
        DatabaseReference refDriver = FirebaseDatabase.getInstance().getReference().child("Users").child("Drivers").child(userId);
        String customerKey = refDriver.getKey().toString();
        GeoFire geoFireCustomer = new GeoFire(refDriver);
        geoFireCustomer.removeLocation(customerKey);
